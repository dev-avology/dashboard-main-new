...
import GuestLayout from "@/components/Layouts/GuestLaout";
...
const SignIn: React.FC = () => {
  return (
    <GuestLayout>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark w-full max-w-screen-md mx-auto">
